// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DefaultWebApiConfig.cs" company="Naos Project">
...
namespace Naos.Bootstrapper
{
    ...
    {
        /// <summary>
        /// Gets a default implementation to initialize the HTTP configuration with a new
        ...
        /// <summary>
        /// Gets an implementation to initialize the HTTP configuration with a custom ExceptionLogger.
        /// </summary>
