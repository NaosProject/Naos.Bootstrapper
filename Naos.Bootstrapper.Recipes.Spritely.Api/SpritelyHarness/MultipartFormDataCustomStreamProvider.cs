// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultipartFormDataCustomStreamProvider.cs" company="Naos Project">
...
namespace Naos.Bootstrapper
{
    ...
    /// message to custom streams. (Inspired by source for MultipartFileStreamProvider.)
    /// </summary>
    public class MultipartFormDataCustomStreamProvider : MultipartStreamProvider, IDisposable
    {
        ...
        public MultipartFormDataCustomStreamProvider(CreateWriteStream createWriteStream, int bufferSize = DefaultBufferSize)
        {
            ...
            this.contents.CollectionChanged += this.ContentCollectionChanged;
            ...
            contentsField?.SetValue(this, this.contents);
        }
        ...
        public override Stream GetStream(HttpContent parent, HttpContentHeaders headers)
        {
            ...
            if (!string.IsNullOrEmpty(contentDisposition.FileName))
            {
                ...
                return this.createWriteStream(fileName, this.FormData, headers);
            }
            ...
            if (e.Action == NotifyCollectionChangedAction.Add)
            {
                ...
                if (content != null)
                {
                    ...
                    if (string.IsNullOrEmpty(contentDisposition.FileName))
                    {
                        ...
                        this.FormData.Add(formFieldName, content.ReadAsStringAsync);
                    }
                }
            }
        }
