// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContainerExtensions.cs" company="Naos Project">
...
namespace Naos.Bootstrapper
{
    ...
    {
        private const string ContainerInitializersKey = "Naos.Bootstrapper.Spritely.Api.WebApi.AppBuilder.ContainerIntializers";
        private const string ContainerKey = "Naos.Bootstrapper.Spritely.Api.WebApi.AppBuilder.Container";
        ...
        public static TService GetInstance<TService>(this IAppBuilder app)
